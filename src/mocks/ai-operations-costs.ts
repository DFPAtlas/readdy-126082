...
export const demoCostBySite: CostBySite[] = [
  ...
  { siteId: 'wedora', siteName: 'Vowora', today: '£3.30', thisMonth: '£66.00', budget: '£75.00', remaining: '£9.00', forecast: '£80.10', budgetStatus: 'warning' },
...
export const demoCostByAgent: CostByAgent[] = [
  ...
  { agentId: 'wd-photo', agentName: 'Photo Moderation Agent', site: 'Vowora', jobs: 36, costToday: '£1.62', monthlyCost: '£32.40', avgCostPerRun: '£0.05', budgetStatus: 'healthy' },
...
export const demoBudgets: AiBudget[] = [
  ...
  { id: 'BUD-0006', name: 'Vowora AI', scope: 'site', scopeId: 'wedora', scopeLabel: 'Vowora', monthlyLimit: '£75.00', dailyLimit: '£3.00', warningThreshold: 70, criticalThreshold: 90, currentSpend: '£66.00', forecast: '£80.10', remaining: '£9.00', status: 'warning', ownerTeam: 'Vowora Planning', environment: 'production', startDate: '2026-08-01', reviewDate: '2026-09-01', notes: '' },
...
export const demoBudgetAlerts: BudgetAlert[] = [
  ...
  { id: 'BTA-007', scope: 'site', scopeId: 'wedora', scopeLabel: 'Vowora', title: 'Model usage spike', severity: 'low', currentSpend: '£66.00', threshold: '70% of £75.00', forecast: '£80.10', suggestedAction: 'Monitor vision-moderation spend.', relatedRecordId: 'wedora', relatedRecordType: 'site' },
];
