...
export const demoLiveActivityEvents = [
  ...
  { id: 'evt-11', timestamp: '10:30:14', site: 'Vowora', sourceType: 'monitoring', actor: 'Monitoring Agent', event: 'Duplicate invitation flag raised', status: 'alert', severity: 'low', referenceType: 'site', referenceId: 'wedora' },
  ...
  { id: 'evt-13', timestamp: '10:25:24', site: 'Vowora', sourceType: 'run', actor: 'RSVP Agent', event: 'RSVP batch retry scheduled (DB lock)', status: 'retry', severity: 'low', referenceType: 'run', referenceId: 'RUN-4C77E' },
...
export const demoOperationsAlerts = [
  ...
  { id: 'ALT-1007', site: 'wedora', siteName: 'Vowora', source: 'Seating Agent', message: 'Duplicate invitation flag detected.', severity: 'low', detectedAt: '10:31', state: 'Open', recommendedAction: 'Review duplicate invitations.', referenceType: 'site', referenceId: 'wedora' },
];
