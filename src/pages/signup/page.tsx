      ...
      <div className="flex-1 flex items-center justify-center px-4 md:px-10">
        <div className="w-full max-w-[420px] text-center">
          ...
          <div className="w-16 h-16 bg-accent-500/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
            <i className="ri-lock-2-line text-accent-400 text-3xl w-8 h-8 flex items-center justify-center"></i>
          </div>

          <h1 className="font-heading text-3xl md:text-4xl font-bold text-foreground-50 mb-3">
            Invite only
          </h1>
          <p className="text-sm text-foreground-400 mb-8 leading-relaxed">
            DFP Command Centre is invite only. If you need access, contact the
            Command Centre owner to receive an invitation.
          </p>

          <Link
            to="/login"
            className="inline-flex items-center justify-center w-full bg-accent-500 hover:bg-accent-400 text-background-950 font-semibold text-sm px-6 py-3 rounded-full transition-all duration-200 whitespace-nowrap cursor-pointer"
          >
            Sign in
          </Link>
        </div>
