...
FROM (VALUES
  ...
  ('KNOW-WD-PLAN','Wedding Planning Workflow','Workflow for building planning timelines and coordinating wedding logistics.','sop','site','wedora','active','internal','Medium','kb/wedora/planning-workflow','Wedora Ops',true,true,NULL,true,true,false,'2026-08-11',true),
  ('KNOW-WD-RSVP','RSVP Rules','Business rules governing RSVP responses, attendance tracking and guest list reconciliation.','business_rules','site','wedora','active','internal','Medium','kb/wedora/rsvp-rules','Wedora Ops',true,true,NULL,true,true,false,'2026-08-14',true),
  ('KNOW-WD-SUPPLIER','Supplier Management Guide','Guide to coordinating wedding suppliers, chasing quotes and managing contracts.','documentation','site','wedora','active','internal','Medium','kb/wedora/supplier-management','Wedora Ops',true,true,NULL,true,true,false,'2026-08-09',true),
