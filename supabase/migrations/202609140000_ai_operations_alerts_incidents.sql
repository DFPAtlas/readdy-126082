...
FROM (VALUES
  ...
  ('ALR-5050','Wedora RSVP notification failure','The RSVP agent failed to send guest notifications due to an email connection issue.','tool_connection','Connection health check','wedora','wd-rsvp','RUN-3C9B7',NULL,NULL,'CON-EMAIL',NULL,'high','high','investigating','high',1,'2026-08-25 09:15','2026-08-25 10:05','2026-08-25 09:20','Wedora Operations','','','Email connection degraded.'),
  ('ALR-5051','Wedora supplier quote chase failure','The supplier agent failed to chase an outstanding quote.','run_failure','Run monitor','wedora','wd-supplier','RUN-8B44D',NULL,NULL,NULL,NULL,'medium','normal','acknowledged','medium',1,'2026-08-25 08:05','2026-08-25 08:50','2026-08-25 08:15','Wedora Operations','','','Low impact.'),
  ...
  ('ALR-5091','Wedora seating validation resolved','A seating chart validation failure was fixed and re-verified.','uat','UAT runner','wedora','wd-seating',NULL,NULL,NULL,NULL,NULL,'medium','normal','resolved','medium',1,'2026-08-24 15:40','2026-08-24 17:30','2026-08-24 15:50','Wedora QA','2026-08-24 17:30','Seating validation re-run and passed.','Closed today.'),
...
FROM (VALUES
  ...
  ('INC-8150','Wedora RSVP notification failure','The RSVP agent failed to send guest notifications due to an email connection issue.','wedora','high','high','investigating','tool_connection','Wedora Operations','Platform Engineering','Guest notifications not delivered.','Email connection failure.','Email connection failure.','Verify email connection and resend notifications.','','','',false,false,false,'2026-08-25 09:15','2026-08-25 09:20','','',''),
