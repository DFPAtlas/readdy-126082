...
INSERT INTO ai_sites (
  ...
  ('digital-footprint', 'Digital Footprint', 'Digital Footprint Platform', 'digital-footprint.uk', 'The group flagship platform. Central command centre, client portal, support operations and cross-group automation hub.', 'platform', 'production', 'healthy', 'active', 'critical', 'DFP Core Team', 'digitalfootprint/platform', 'RDDY-DFP-001', 'supabase-dfp-prod', 'n8n-dfp-core', 'Stripe', 'Resend', 'Supabase Auth', 'Vercel', 'Flagship control plane. Highest availability target across the group.', true),
  ...
  ('wedora', 'Vowora', 'Vowora Weddings', 'vowora.uk', 'Wedding planning platform coordinating guests, RSVPs, suppliers, seating plans and day-of logistics.', 'platform', 'production', 'healthy', 'active', 'high', 'Vowora Ops', 'wedora/app', 'RDDY-WD-011', 'supabase-wd-prod', 'n8n-wedora', 'Stripe', 'Resend', 'Supabase Auth', 'Vercel', 'Seating agent flagged a duplicate invitation; minor alert open.', true),
  ('the-forge', 'The Forge', 'The Forge Studio', 'theforges.org', 'Internal build studio and prompt engineering workbench powering code generation, testing and release validation across the group.', 'product', 'production', 'critical', 'partial', 'critical', 'Forge Team', 'theforge/studio', 'RDDY-TF-003', 'supabase-tf-prod', 'n8n-theforge', 'Stripe', 'Resend', 'Supabase Auth', 'Vercel', 'Release validation failed on latest build; deploy agent awaiting approval.', true)
