...
from (values
  ...
  ('ORC-7018','Wedora wedding planning timeline','Coordinate multi-agent wedding planning from timeline through RSVP and supplier coordination.','workflow','user','Wedding planning','wedora','production','normal','low','completed','Wedding planning','96%','wd-planner',null,'RUN-3B66D','pass','pass',false,false,false,false,'','COR-1081','retry same agent','—','Wedding timeline, RSVP and supplier coordination completed.','Wedora Ops',false),
...
from (values
  ...
  ('ORC-7007','site_resolved','Wedora','Planning capability present.',null),
  ('ORC-7007','agent_selected','Seating Agent','Seating specialist for Wedora.','wd-seating'),
  ...
  ('ORC-7018','site_resolved','Wedora','Planning capability present.',null),
