...
FROM (VALUES
  ...
  ('APR-4502','Issue partial refund','Issue a partial refund for a Vowora booking adjustment.','wedora','wd-budget',NULL,'Issue partial refund','billing','red','high','production','approved_with_conditions','AI Agent','Group AI Operations',1,1,'Required to resolve an active operational issue.','Evidence supports the action; human sign-off is required before execution.','Requested change applied and verified.','Contained, reversible impact.',true,'Restore from pre-change snapshot.',true,false,true,'approve_with_conditions','Approved pending final invoice verification.','Vowora Finance','Verify final invoice total before processing.',''),
